...
3. get_fred_timeseries(series_id, start_date?) - Get FRED historical data for charting. Returns array of [date, value] pairs. Use for: trends, charts, historical analysis, "over time", "history of"
